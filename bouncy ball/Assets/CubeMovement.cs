...
public class CubeMovement : MonoBehaviour
{
        ...
        void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                m_Normalized = NormallizeVectors(clickPosition, transform.position);
            }
        }
